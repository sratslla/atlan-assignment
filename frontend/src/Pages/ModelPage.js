...
const ModelPage = () => {
	...
	return (
		<>
			<Navbar />
			{/* <div className="flex justify-between p-4 font-[Outfit,sans-serif] overflow-hidden ">
				<img
					src={data.model.imageURL}
					alt="Laptop"
					className="rounded-lg object-cover w-1/3 basis-1/3 ml-6 mt-6 hidden md:block"
				/>
				<div className="my-10 p-6 flex flex-col justify-around group w-screen md:basic-2/3">
					<div className="flex justify-between">
						<div>
							...
							<div className="">
								<span class="mb-2 mr-2 inline-block rounded-full bg-gray-100 p-2 py-1 text-[15px] font-semibold text-gray-900">
									{data.model.category}
								</span>
							</div>
						</div>
					...
					<div className="shadow-lg rounded-2xl p-2 bg-slate-100 font-mono">
						<pre>{data.model.codeSnippet}</pre>
					</div>
				</div>
			</div> */}
